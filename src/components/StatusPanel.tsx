...
/**
 * The **StatusPanelSSEStatus** displays the SSE connection status as a small icon with a tooltip.
 */
const StatusPanelSSEStatus: React.FC<{ status: ConnectionStatus; message?: string }> = ({ status, message }) => {
